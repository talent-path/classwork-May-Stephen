...
public class ConnectFourInMemDao implements ConnectFourDao{
    ...
    @Override
    public ConnectFourGame getGameById(Integer gameId) throws InvalidGameIdException {
    ...
    @Override
    public int startGame(Integer[][] board) throws NullBoardException {
        if( board == null) {
            throw new NullBoardException("Tried to start a game with a null board");
        }
        int id = 0;
